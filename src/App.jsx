...
const Portfolio = () => {
  ...
  const certifications = [
    { title: "Generative AI Leader", date: "2026", color: "from-purple-400 to-indigo-500", icon: <Cpu /> },
    { title: "LF Certified Kubestronaut", date: "2025", color: "from-yellow-400 to-orange-500", icon: <Award /> },
    { title: "CKS: Security Specialist", date: "2024", color: "from-red-500 to-pink-600", icon: <Shield /> },
    { title: "CKA: Administrator", date: "2022", color: "from-blue-400 to-cyan-500", icon: <Server /> },
    { title: "CKAD: App Developer", date: "2022", color: "from-blue-400 to-cyan-500", icon: <Code /> },
    { title: "AWS Solutions Architect", date: "2021", color: "from-orange-400 to-yellow-500", icon: <Cloud /> },
    { title: "Red Hat Certified Engineer", date: "2021", color: "from-red-600 to-red-800", icon: <Terminal /> },
  ];
  ...
  const awards = [
    {
      ...
      desc: "For innovating through empathy and understanding"
    },
    {
      title: "Spotlight Award",
      desc: "For coordinating with multiple teams and streamlining operations"
    },
    {
      title: "Appreciate Excellence - Renewal",
      desc: "For outstanding support in multiple projects"
    },
    {
      title: "Celebrate Excellence - Achievement",
      desc: "Adjudged winner of the GSID Quarterly Excellence Awards in Value Champion category"
    },
    {
      title: "Appreciate Excellence - Achievement",
      desc: "For successful restoration of services and minimizing impact to the customer"
    },
    {
      title: "Applaud Excellence - Achievement (Team award)",
      desc: "For excellent support during first time IMS delivery in XXX project"
    },
    {
      title: "Applaud Excellence - Achievement",
      desc: "For successful deployment of XXX on OpenStack."
    },
    {
      title: "Appreciate Excellence - Open (Team award)",
      desc: "For successful acceptance closure of XXXX IMS project."
    },
    {
      title: "Applaud Excellence - Fearless (Team award)",
      desc: "For managing multiple issues during all phases of project"
    },
    {
      title: "Applaud Excellence - Fearless",
      desc: "For being a pillar to many deliveries and providing expert services"
    },
    {
      title: "Business Excellence - Fearless (Team award)",
      desc: "For efforts in securing a successful delivery project to XXXX"
    }
  ];
    ...
    <div className="bg-slate-900 text-slate-100 min-h-screen font-sans selection:bg-cyan-500 selection:text-black overflow-x-hidden">
      ...
      <section id="awards" className="py-24 px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-slate-400 mb-16">Recognition for collaboration, innovation, and delivery excellence</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {awards.map((award, index) => (
              <motion.div
                ...
                className="p-6 bg-slate-800 rounded-xl border border-slate-700 shadow-lg hover:border-cyan-500/50 transition"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-300 leading-relaxed mt-2">{award.desc}</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
             <HobbyCard 
                icon={<Camera />} 
                title="Photography" 
                desc="Capturing nature and landscapes. Exploring visuals through editing."
             />
             <HobbyCard 
                icon={<Cpu />} 
                title="DIY Electronics" 
                desc="Building projects on SBCs like Raspberry Pi and exploring embedded systems."
             />
             <HobbyCard 
                icon={<Plane />} 
                title="Aerospace" 
                desc="Deep interest in avionics, aerospace tech, and exploring new cultures."
             />
          </div>
        </div>
      </section>
